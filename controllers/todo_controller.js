...
module.exports.addNewItems = async function(req, res){
...
module.exports.markItemsAsComplete = async function(req, res){
...
module.exports.markItemsAsIncomplete = async function(req, res){
    const {sequelize} = require("../models/index");
    const {QueryTypes} = require("sequelize");
